...
\begin{schema}{Leave\_Document}
    \pk{\fk{document\_id}, \fk{request\_id}}
\end{schema}
\schemacomment{Leave\_Document.document\_id references Document.document\_id}
\schemacomment{Leave\_Document.request\_id references Request.reqeust\_id}
\newpage 
